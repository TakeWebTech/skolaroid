...
import { organizationJsonLd, siteConfig, siteUrl, websiteJsonLd } from '@/lib/seo';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: siteUrl('/brand/skolaroid-logo.webp'), width: 1200, height: 630 }],
  },
  twitter: {
    ...
    description:
      'One intelligent platform to run your entire school. Administration, academics, finance, communication and learning — connected.',
    images: [siteUrl('/brand/skolaroid-logo.webp')],
  },
  icons: {
    icon: [
